  ...
  return (
    <div className="flex flex-col items-center">
      <div className="text-white w-[22.5rem] md:w-3/4 lg:w-[50rem] bg-cyan-600 h-max-content py-4 mt-8 rounded-md shadow-xl">
        ...
        <div className="flex justify-between items-center mt-12 pr-4 md:px-12">
          ...
          <div className="flex flex-col items-start gap-1">
            <div className="flex items-center">
              ...
              <span className="text-xs font-medium ml-1">19</span>
              <span>&deg;</span>
            </div>
            <div className="flex items-center">
              <WiHumidity size={25} />
        ...
        <div className="flex flex-wrap justify-center mt-8 px-4 gap-x-12">
